...
//Location Bar Enhancer5.1;Loading Bar0.3.0
	var cssStr = (function(){/*
			#urlbar {
				background-image: -moz-repeating-linear-gradient(top -45deg, rgba(255,255,255,0), rgba(255,255,255,0) 6px, #C5C5C5 6px, #C5C5C5 12px), -moz-linear-gradient(left, rgba(255,255,255,0) 0%,  rgba(0,0,0,.06)  100%);
				background-size:0 0;
				background-repeat:repeat-x, no-repeat;
				transition: background-size 0s ease 0s !important;
			}
