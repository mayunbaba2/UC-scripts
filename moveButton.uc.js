...
location == "chrome://browser/content/browser.xul" && (function(){
    ...
    /*{ id: "Saying-icon", insertAfter: "gTranslator" },*///saying ico
		{ id: "MemoryDisplay", insertBefore: "titlebar-min" },//内存监视器
		{ id: "anobtn", bar: "urlbar-icons" },//anobtn
    { id: "ReStartBtn", bar: "urlbar-icons" },//重启按钮
    { id: "pocket-button", bar: "urlbar-icons" },//pocket按钮
    { id: "sidebar-button", bar: "urlbar-icons" },//侧边栏按钮
    { id: "downloads-button", bar: "urlbar-icons" },//下载按钮
    { id: "gTranslator", insertAfter: "ProfilesButton" },//谷歌翻译
    { id: "userChromebtnMenu", bar: "urlbar-icons" },//UC脚本
    { id: "stylish-toolbar-button", bar: "urlbar-icons" },//stylish
    { id: "greasemonkey-tbb", bar: "urlbar-icons" },//油猴子
