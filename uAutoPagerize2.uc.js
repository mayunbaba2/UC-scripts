...
// @note           2014.11.02 自用调整为左键弹出菜单，右键开启/关闭
...
var ns = window.uAutoPagerize = {
    ...
    get file() {
        ...
        aFile.appendRelativePath('Local\\_uAutoPagerize.js');
        delete this.file;
    ...
    get file_CN() {
        var aFile = Services.dirsvc.get('UChrm', Ci.nsILocalFile);
        aFile.appendRelativePath(DB_FOLDER);
        aFile.appendRelativePath('Local\\uSuper_preloader.db.js');
        delete this.file_CN;
    ...
    get file_DB_JSON() {
        var aFile = Services.dirsvc.get('UChrm', Ci.nsILocalFile);
        aFile.appendRelativePath(DB_FOLDER);
        aFile.appendRelativePath('Local\\uAutoPagerize.json');
    ...
    init: function() {
        ...
        if (Config.isUrlbar) {
            ns.icon = $('urlbar-icons').appendChild($C("image", {/*toolbarbutton*/
                id: "uAutoPagerize-icon",
                tooltiptext: "自动翻页",
                onclick: "if (event.button == 2) { event.preventDefault(); event.stopPropagation(); closeMenus(event.currentTarget);  uAutoPagerize.iconClick(event);}",
                popup: "uAutoPagerize-popup",
//				type: "menu",
        ...
        var xml = '\
            <menupopup id="uAutoPagerize-popup" position="after_end"\
                       ignorekeys="true"\
...
#uAutoPagerize-icon {\
	list-style-image: url(\
		data:image/png;base64,\
		);\
	-moz-image-region: rect(0px 16px 16px 0px );\
}\
#uAutoPagerize-icon > image{ padding:3px 3px !important; border: 0 !important;}\
#uAutoPagerize-icon > dropmarker{display:none !important;}\
\
